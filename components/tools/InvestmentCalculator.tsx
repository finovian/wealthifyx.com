...
/* ─── Main component ─────────────────────────────────── */
export default function InvestmentCalculator({ initialValues }: InvestmentCalculatorProps) {
  ...
  const [frequency, setFrequency] = useState(initialValues?.frequency ? parseInt(initialValues.frequency) : 1);
